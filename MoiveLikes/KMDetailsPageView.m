...
- (void)addGradientToView:(UIView *)view
{
    ...
    gradientLayer.frame = CGRectMake(0.0f, 0, self.tableView.frame.size.width, kDefaultTableViewHeaderMargin);
    gradientLayer.colors = [NSArray arrayWithObjects:(id)[[UIColor colorWithRed:0 green:0 blue:0 alpha:0.2] CGColor], [(id)[UIColor colorWithRed:0 green:0 blue:0 alpha:0] CGColor], nil];
